                        ...
                        <div class="card card-xxl-stretch">
                            ...
                            <div class="card-header border-0 pt-5 pb-3">
                                ...
                                <div class="card-toolbar">
                                    <div class="my-1">
                                        <a href="<?= base_url('supplier/form') ?>" class="btn btn-sm btn-rounded btn-success"><i class="fa-solid fa-plus"></i>Tambah Data</a>
                                ...
                                <div class="table-responsive">
                                    <table class="table align-middle table-row-bordered table-row-dashed gy-5"
                                        ...
                                        <tr class="text-start text-gray-400 fw-boldest fs-7 text-uppercase">
                                                <th>No.</th>
                                                <th class="min-w-200px px-0">Supplier</th>
                                            ...
                                            <tr>
                                                ...
                                                <td class="p-0">
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <div class="ps-3">
                                                            <a href="#"
                                                                class="text-gray-800 fw-boldest fs-5 text-hover-primary mb-1"><?= $row->nama_supp; ?></a>
                                                        </div>
                                                    </div>
                                                ...
                                                <td class="p-0">
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <div class="ps-3">
                                                            <span class="text-gray-800 fw-bold fs-5 text-hover-primary mb-1"><?= $row->no_hp; ?></a>
                                                        </div>
                                                    </div>
                                                </td>
                                                ...
                                                <td class="pe-0 text-end">
                                                    ...
                                                    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg-light-primary fw-bold w-200px py-3"
                                                        ...
                                                        <!--begin::Menu item-->
                                                        <div class="menu-item px-3">
                                                            <a href="<?= base_url('supplier/form').'/'.$row->id; ?>" class="menu-link px-3"><i class="far fa-solid fa-pen-to-square text-warning"></i>Edit</a>
                                                        </div>
                                                        <!--end::Menu item-->

                                                        <!--begin::Menu item-->
                                                        <div class="menu-item px-3">
                                                            <a href="<?= base_url('supplier/hapus').'/'.$row->id; ?>" class="menu-link px-3"><i class="far fa-sharp fa-solid fa-trash text-danger"></i>Hapus</a>
                                                        </div>
                                                        <!--end::Menu item-->
