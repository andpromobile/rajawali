                                    ...
                                    <div class="row mb-8">
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <input required type="text" class="form-control form-control-solid"
                                                placeholder="Masukkan nama Pelanggan" name="nama"
                                                value="<?= isset($query)?$query->nama:''; ?>"
                                            oninvalid="this.setCustomValidity('Nama pelanggan perlu Diisi !')"
                                    ...
                                    <div class="row mb-8">
                                        <div class="col-md-12">
                                            ...
                                            <textarea class="form-control form-control-solid"
                                                placeholder="Keterangan Pelanggan." name="alamat" id="" cols="30"
                                    ...
                                    <div class="row mb-8">
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <input type="text" class="form-control form-control-solid"
                                                placeholder="Masukkan nomor handphone." name="nomor_hp"
                                                value="<?= isset($query)?$query->nomor_hp:'-'; ?>">
                                        </div>
