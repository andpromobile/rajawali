                        ...
                        <div class="card card-xxl-stretch">
                            ...
                            <div class="card-header border-0 pt-5 pb-3">
                                ...
                                <div class="card-toolbar">
                                    <div class="my-1">
                                        <!--begin::Select-->
                                        <select class="form-select fw-bold w-125px" data-control="select2"
                                ...
                                <div class="card card-xxl-stretch-50 mb-xxl-8">
                                    ...
                                    <div class="card-body pt-5">
                                        ...
                                        <span
                                            ...
                                            <i class="fas fa-exclamation-circle text-warning me-3 fs-3"></i>Only New
                                            Users</span>
                                        <!--end::Label-->
                                    </div>
                                    <!--end::Body-->
                            ...
                            <div class="card-body pt-1">
                                ...
                                <div class="rounded border border-primary bg-light-primary border-dashed px-6 py-5">
                                    <a href="#" class="link-primary fw-bolder fs-6 me-1">Intive New .NET
                                        Collaborators</a>
                                    <span class="text-gray-800 fw-bold fs-6">to creating great outstanding business to
                                        business .jsp modular class outstanding scripts</span>
                                </div>
                                <!--end::Alert-->
                            </div>
                            <!--end::Body-->
